        ...
        <div className="flex flex-col gap-5 px-6 pb-8">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <p className="font-sans text-[11px] font-medium text-gold uppercase tracking-[0.08em]">
                Engine
              </p>
            </div>
            {hasEngineActivity ? (
              ...
              <div className="flex items-center justify-between bg-card rounded-2xl px-4 py-3">
                ...
                {!isFuture && (
                  <button
                    type="button"
                    onClick={goToEngine}
                    className="font-sans text-[11px] font-medium text-gold bg-transparent border-none cursor-pointer"
                  >
                    Go to Engine →
                  </button>
                )}
